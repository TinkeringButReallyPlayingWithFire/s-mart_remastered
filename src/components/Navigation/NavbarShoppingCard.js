...
function NavbarShoppingCard() {
  const [closedShoppingCard, setclosedShoppingCard] = useState(false);
  return (
    <div className="navbarShoppingCardContainer">
      <div class="row">
...
export default NavbarShoppingCard;
